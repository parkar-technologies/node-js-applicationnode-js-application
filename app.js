...
console.log(__dirname+"/images/wizdomlogo.jpg");
*/
app.get('/wizdomtechnologies', function(request, response) {
    //response.send("<h2><center>Welcome to Node JS app</h2>");
    response.write("<h2><center><u>Node JS  Application </u></center></h2>");
	
    response.write("<h2><center>Welcome to  Wizdom Technologies. Please Contact +91-9390959584,++91-8309540541 for more information or send an email to wizdomtechnologys@gmail.com <center></h2>" );
    response.end();
...
app.get("/html", function(req,res){
    ...
    app.get("/jsonData", function(req,res){
        ...
        //res.json({'name': 'Wizdom'});
        res.send({
		'name': 'Wizdom Technologies',
		'technology': 'DevOps',
		'contact' : '9390959584',
		'email': wizdomtechnologys@gmail.com'
	            });
...
app.get('/redirect', function(req, res) {
    //Send status 300
        res.redirect('http://wizdomtechnologies.com');
    });
    
 
    app.listen(app.get('port'), function() {
        console.log("Node JS app is running at http://localhost:" + app.get('port') +"/wizdomtechnologies");
      })
